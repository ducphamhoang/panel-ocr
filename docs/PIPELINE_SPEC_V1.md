...
2026-08-06 the numbered markers present under `src/` are **1–16, 18, 19 and 21** — so **17, 22 and
24–27 have no site comment today**, and nothing here should be read as asserting anything about
any other row. Two traps in that measurement, both hit while writing this sentence: a marker in a
...
counted above. Rows 24–27 are §16.38's and await tasks L1–L6; 17's and 22's state is pre-existing,
